...
func (c *StorageV1alpha1Client) Buckets() BucketInterface {
	return newBuckets(c)
}

func (c *StorageV1alpha1Client) BucketAccesses() BucketAccessInterface {
	return newBucketAccesses(c)
}

func (c *StorageV1alpha1Client) BucketAccessClasses() BucketAccessClassInterface {
	return newBucketAccessClasses(c)
}

func (c *StorageV1alpha1Client) BucketAccessRequests(namespace string) BucketAccessRequestInterface {
...
func (c *StorageV1alpha1Client) BucketRequests(namespace string) BucketRequestInterface {
