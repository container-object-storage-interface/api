...
var bucketclassesResource = schema.GroupVersionResource{Group: "cosi.sigs.k8s.io", Version: "v1alpha1", Resource: "bucketclasses"}

var bucketclassesKind = schema.GroupVersionKind{Group: "cosi.sigs.k8s.io", Version: "v1alpha1", Kind: "BucketClass"}
