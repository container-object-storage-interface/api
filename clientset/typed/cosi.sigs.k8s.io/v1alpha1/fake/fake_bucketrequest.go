...
var bucketrequestsResource = schema.GroupVersionResource{Group: "cosi.sigs.k8s.io", Version: "v1alpha1", Resource: "bucketrequests"}

var bucketrequestsKind = schema.GroupVersionKind{Group: "cosi.sigs.k8s.io", Version: "v1alpha1", Kind: "BucketRequest"}
