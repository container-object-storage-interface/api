	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.StorageV1alpha1().Buckets().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.StorageV1alpha1().Buckets().Watch(context.TODO(), options)
			},
		},
		&storagek8siov1alpha1.Bucket{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *bucketInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&storagek8siov1alpha1.Bucket{}, f.defaultInformer)
}
