...
var bucketsResource = schema.GroupVersionResource{Group: "cosi.sigs.k8s.io", Version: "v1alpha1", Resource: "buckets"}

var bucketsKind = schema.GroupVersionKind{Group: "cosi.sigs.k8s.io", Version: "v1alpha1", Kind: "Bucket"}
