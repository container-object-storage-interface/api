...
import (
	...
	"github.com/container-object-storage-interface/api/client/clientset/scheme"
...
// CosiV1alpha1Client is used to interact with features provided by the cosi.sigs.k8s.io group.
...
func (c *CosiV1alpha1Client) BucketRequests(namespace string) BucketRequestInterface {
	return newBucketRequests(c, namespace)
}

// NewForConfig creates a new CosiV1alpha1Client for the given config.
func NewForConfig(c *rest.Config) (*CosiV1alpha1Client, error) {
	config := *c
	...
	return &CosiV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new CosiV1alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *CosiV1alpha1Client {
...
// New creates a new CosiV1alpha1Client for the given RESTClient.
func New(c rest.Interface) *CosiV1alpha1Client {
	return &CosiV1alpha1Client{c}
}
