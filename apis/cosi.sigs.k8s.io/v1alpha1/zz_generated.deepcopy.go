...
func (in *BucketAccessClass) DeepCopyInto(out *BucketAccessClass) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.PolicyActions.DeepCopyInto(&out.PolicyActions)
	if in.SupportedProtocols != nil {
		in, out := &in.SupportedProtocols, &out.SupportedProtocols
		*out = make([]ProtocolSignature, len(*in))
		copy(*out, *in)
	}
...
func (in *BucketClass) DeepCopyInto(out *BucketClass) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	if in.AdditionalPermittedNamespaces != nil {
		in, out := &in.AdditionalPermittedNamespaces, &out.AdditionalPermittedNamespaces
	...
	if in.AnonymousAccessModes != nil {
		in, out := &in.AnonymousAccessModes, &out.AnonymousAccessModes
		*out = make([]AnonymousAccessMode, len(*in))
		copy(*out, *in)
	}
	if in.Parameters != nil {
		in, out := &in.Parameters, &out.Parameters
...
func (in *BucketStatus) DeepCopyInto(out *BucketStatus) {
	*out = *in
	out.BoundBucketRequests = in.BoundBucketRequests
	return
}
